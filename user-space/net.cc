...
static int UpdateNetProtectStatus(uint8_t status) {
...
int EnableNetProtect() { return UpdateNetProtectStatus(NET_PROTECT_ENABLE); }
int DisableNetProtect() { return UpdateNetProtectStatus(NET_PROTECT_DISABLE); }
